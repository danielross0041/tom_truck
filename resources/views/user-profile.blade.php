                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="contact_number" id="validationCustomUsername" placeholder="Contact Number" aria-describedby="inputGroupPrepend" value="{{$user->contact_number}}" required>
