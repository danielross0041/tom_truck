            ...
            @if($attributes && Helper::can_view($slug))
                ...
                @foreach($attributes as $att)
                    @if($att->attribute == $slug)
                        @if($slug == "profile")
                        @else
                            <div class="col-12 col-md-6 col-lg-3 mt-3 {{($slug == 'roles')?'role-assign-modal':(($slug == 'vendors' || $slug == 'contact-details' || $slug == 'product-inquiry')?'':'updateevent')}}" data-role_id="{{$att->id}}" data-rolename='{{$att->role}}' data-slug='{{$slug}}' style="cursor: pointer;">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="d-flex">
                                                ...
                                                <div class="media-body align-self-center pl-3">
                                                    ...
                                                    <p class="mb-0 font-w-500 h6"> Add {{ucwords(str_replace("_", " ", $att->role))}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
